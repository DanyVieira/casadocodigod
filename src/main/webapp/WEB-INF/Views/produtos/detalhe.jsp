	    ...
	    <ul id="variants" class="clearfix">
		 ...
		 <c:forEach  items="${produto.precos } " var= "preco">
	    	  <li class="buy-option" itemprop="offers" itemscope> 
	            ...
	            <label  itempropy="category" itemscope class="variant-label">${preco.tipo} </label>
	            <small class="compare-at-price">R$ 39,90</small>
	            <p class="variant-price" itemprop="price">${preco.valo} </p>
	          </li> 
	...
	<footer id="layout-footer">
		<div class="clearfix container">
			...
			<div id="social-footer">
				...
				<ul>
					<li class="social-links"><a href="http://www.twitter.com/casadocodigo" target="_blank"
